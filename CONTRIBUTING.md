# Contributing to Political Factions
...
## Pull requests are the best way to propose changes to the source code. We actively welcome your pull requests:
...
## Report bugs using Github's [issues](https://github.com/DataAccess2020/PoliticalFactions/issues)
We use GitHub issues to track bugs and problems. Report a bug by [opening a new issue](); it's that easy!
