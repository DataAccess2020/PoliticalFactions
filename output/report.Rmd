...
To visualize the resulting network, we plot it tuning the arguments to obtain the most precise result. To better position the nodes, we applied an algorithm that spread them using a physical simulation. For this analysis, we emplyed the Fruchterman-Reingold [-@fruchterman_graph_1991].
